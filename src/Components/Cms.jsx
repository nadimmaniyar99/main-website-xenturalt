...
import './cms.css'; // You can style accordingly
    ...
    <div className="service-section">
      <div className="service-container">
        <div className="service-right">
          <h1>CMS & WordPress Development</h1>
          <p>We provide comprehensive solutions for Content Management Systems, from custom WordPress development to migration and maintenance..</p>
          ...
          <div className="service-boxes">
            {["ios", "android", "flutter", "react"].map((key, index) => {
              const titles = {
                ios: "Wordpress Website",
                android: "Custom Cms",
                flutter: "E-commerce Solutions",
                react: "CMS Migration"
              };
              const images = {
                ios: "img/wordpress.png",
                android: "img/setting.png",
                flutter: "img/cart.png",
                react: "img/arrow.jpg"
              };
