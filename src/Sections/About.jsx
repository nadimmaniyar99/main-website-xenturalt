    ...
    <div>
      <section className="about-section">
        <div className="content">
          <h1><span className="highlight">A</span>bout us</h1>
          <div className="vision-section">
            <div className="text">
              <h2><span className="highlight">Our</span> Vision</h2>
              <p><strong>Xenturalt Codes IT Solutions</strong>, our vision is to be a global leader in delivering innovative IT solutions...</p>
              <p>By staying ahead of industry trends and embracing new technologies...</p>
            </div>
            <div className="image">
      ...
      <section className="Team">
        ...
        <div className="team-container" id="team-container">
          {[
            { src: 'roni-bhi.jpg', name: 'Roni Mitra', role: 'Establisher', type: 'directors' },
